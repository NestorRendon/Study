...
4. **Indexing & vector stores** — ANN search at scale ([[04 - Indexing and Vector Stores]])
   - **4a. Vector DB deep dive** — from-scratch mechanics ([[04.1 - Vector Databases from Scratch]]) → similarity metrics ([[04.2 - Vector Similarity Metrics]]) → ANN index internals ([[04.3 - Vector Index Types and ANN Algorithms]]) → framework comparison ([[04.4 - Vector Database Frameworks Compared]]) → queries & production tips ([[04.5 - Vector DB Queries Commands and Production Tips]])
...
| 4a | ↳ Vector DBs from scratch | [[04.1 - Vector Databases from Scratch]] |
| 4b | ↳ Similarity metrics (cosine, dot, L2...) | [[04.2 - Vector Similarity Metrics]] |
| 4c | ↳ ANN index types (HNSW, IVF, PQ...) | [[04.3 - Vector Index Types and ANN Algorithms]] |
| 4d | ↳ Frameworks compared (Pinecone, pgvector...) | [[04.4 - Vector Database Frameworks Compared]] |
| 4e | ↳ Queries, commands & production tips | [[04.5 - Vector DB Queries Commands and Production Tips]] |
...
**Prev:** [[06 LLM/07 LLM & Generative AI/00 - Chapter Overview]] · **Next:** [[06 LLM/09 Knowledge Graphs/00 - Chapter Overview]]
